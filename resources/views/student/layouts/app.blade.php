...
<body class="bg-gray-50">
    ...
    <div class="flex min-h-screen relative">
        <aside id="sidebar" class="w-64 bg-blue-900 text-white p-6 absolute inset-y-0 left-0 transform -translate-x-full transition duration-200 ease-in-out z-50 lg:relative lg:translate-x-0 lg:flex flex-col justify-between shadow-2xl lg:shadow-none">
            <div>
                ...
                <nav class="space-y-4">
                    <a href="#" class="flex items-center gap-3 bg-blue-800 p-3 rounded-xl text-sm font-bold shadow-inner">
                        <i class="fas fa-th-large w-5"></i> Overview
                    </a>
                    <a href="#" class="flex items-center gap-3 text-blue-300 p-3 hover:bg-blue-800 rounded-xl transition text-sm">
        ...
        <main class="flex-1 p-4 md:p-8 w-full overflow-x-hidden">
            <div class="mb-6 bg-yellow-400 p-4 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-4 shadow-lg shadow-yellow-100 border border-yellow-500">
                <div class="flex items-center gap-3 text-center md:text-left">
                    <i class="fas fa-shield-alt text-yellow-900 text-xl shrink-0"></i>
                    <p class="text-sm font-bold text-yellow-900 leading-tight">Your account is not secure! Set a password to protect your data.</p>
                </div>
                <a href="" class="bg-yellow-900 text-white px-6 py-2 rounded-xl text-xs font-black uppercase shadow-md hover:bg-black transition whitespace-nowrap">Secure Now</a>
            </div>
